...
public record CreateFacilityRequestDTO(
    ...
    public CreateFacilityRequestDTO(
        ...
        Validate.isTrue(facilityName.length() >= 3 && facilityName.length() <= 80,
                "Facility name must be between 3 and 80 characters");
        Validate.isTrue(facilityDescription.length() >= 3 && facilityDescription.length() <= 200,
        ...
        Validate.isTrue(district.length() >= 2 && district.length() <= 50,
