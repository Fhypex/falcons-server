 ...
 * 
 * import gtu.cse.se.altefdirt.aymoose.facility.internal.application.model.
 * FacilityView;
 * import gtu.cse.se.altefdirt.aymoose.facility.internal.application.service.
 * FacilityService;
 * import gtu.cse.se.altefdirt.aymoose.facility.internal.domain.Facility;
 * import
 * gtu.cse.se.altefdirt.aymoose.facility.internal.domain.FacilityRepository;
 * import
 * gtu.cse.se.altefdirt.aymoose.facility.api.rest.dto.FacilityResponseDTO;
 ...
 * .map(facility ->
 * FacilityResponseDTO.fromView(facilityService.denormalize(facility)))
 ...
 * }
 * return
 * FacilityResponseDTO.fromView(facilityService.denormalize(fetch.get()));
 * }
 * }
 */
