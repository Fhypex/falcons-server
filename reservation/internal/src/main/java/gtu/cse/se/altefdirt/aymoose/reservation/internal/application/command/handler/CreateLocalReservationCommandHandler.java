...
@Slf4j
public class CreateLocalReservationCommandHandler implements CommandHandler<CreateReservation, AggregateId> {
    ...
    public AggregateId handle(CreateReservation command) {
        ...
        log.debug("Local reservation saved {}", savedReservation);
